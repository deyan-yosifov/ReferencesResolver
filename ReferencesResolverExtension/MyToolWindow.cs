...
namespace Telerik.ReferencesResolverExtension
{
    ...
    /// </summary>
    [Guid("7c182eab-a21a-464b-9ea7-be7c4bc97829")]
    public class MyToolWindow : ToolWindowPane
    {
        private readonly MySettingsControl windowContent;
            ...
            base(null)
        {
            ...
            this.windowContent = new MySettingsControl();
            base.Content = this.windowContent;
        }
