...
namespace ReferencesResolverExtension_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Telerik.ReferencesResolverExtension.GuidList.guidReferencesResolverExtensionCmdSet, (int)Telerik.ReferencesResolverExtension.PkgCmdIDList.cmdidAddRemoveReferences);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "ReferencesResolverExtension", "Telerik.ReferencesResolverExtension.ReferencesResolverExtensionPackage");
